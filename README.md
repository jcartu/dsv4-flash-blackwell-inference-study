...
> ### 📄 Companion study: [**GLM-5.2-504B (0xSero Router-KD NVFP4)**](GLM-5.2-504B.md)
>
> A separate, fully-reproducible writeup for serving **GLM-5.2** at **262K context** on the same 4× RTX PRO 6000 Blackwell hardware — image, weights, full launch command, the two non-obvious fixes, and benchmarks (≈95 tok/s single-stream, **96.7%** Estonia). See [**`GLM-5.2-504B.md`**](GLM-5.2-504B.md).
...
- [`data/glm52_0xsero_benchmark_results_standard.json`](data/glm52_0xsero_benchmark_results_standard.json) — GLM-5.2-504B (0xSero) sustained decode + prefill matrix
- [`data/glm52_0xsero_benchmark_results_estonia.json`](data/glm52_0xsero_benchmark_results_estonia.json) — GLM-5.2-504B (0xSero) Estonia profile results (30 runs)
